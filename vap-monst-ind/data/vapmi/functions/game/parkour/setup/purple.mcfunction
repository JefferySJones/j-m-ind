...
execute at @e[name="Jump1P",sort=random,limit=1] positioned ~ ~2.25 ~6.75 run kill @e[distance=0..2,type=item,nbt={Item:{id:"minecraft:spider_eye",tag:{display:{Name:'{"text":"Spider Eye"}'}}}}]
...
execute at @e[name="Jump1P",sort=random,limit=1] positioned ~ ~2.25 ~6.75 run execute at @e[distance=0..2,type=item,nbt={Item:{id:"minecraft:spider_eye",tag:{display:{Name:'{"text":"Spider Eye"}'}}}}] run particle minecraft:dust 1 0.5 0.5 3 ~ ~0.25 ~ 0 0 0 0 3