...
# Summon new villager
execute if score _INVESTMENTS_TIER VillagerStateRed matches 2 if entity @e[team=Red,advancements={vapmi:upgrade_currency_2=true}] run execute at @e[name="CenterR"] positioned ~ ~ ~ run function vapmi:villagers/summon-new-investments-3
execute if score _INVESTMENTS_TIER VillagerStateOrange matches 2 if entity @e[team=Orange,advancements={vapmi:upgrade_currency_2=true}] run execute at @e[name="CenterO"] positioned ~ ~ ~ run function vapmi:villagers/summon-new-investments-3
execute if score _INVESTMENTS_TIER VillagerStateYellow matches 2 if entity @e[team=Yellow,advancements={vapmi:upgrade_currency_2=true}] run execute at @e[name="CenterY"] positioned ~ ~ ~ run function vapmi:villagers/summon-new-investments-3
execute if score _INVESTMENTS_TIER VillagerStateGreen matches 2 if entity @e[team=Green,advancements={vapmi:upgrade_currency_2=true}] run execute at @e[name="CenterG"] positioned ~ ~ ~ run function vapmi:villagers/summon-new-investments-3
execute if score _INVESTMENTS_TIER VillagerStateBlue matches 2 if entity @e[team=Blue,advancements={vapmi:upgrade_currency_2=true}] run execute at @e[name="CenterB"] positioned ~ ~ ~ run function vapmi:villagers/summon-new-investments-3
execute if score _INVESTMENTS_TIER VillagerStateDarkBlue matches 2 if entity @e[team=Dark_Blue,advancements={vapmi:upgrade_currency_2=true}] run execute at @e[name="CenterDB"] positioned ~ ~ ~ run function vapmi:villagers/summon-new-investments-3
execute if score _INVESTMENTS_TIER VillagerStatePurple matches 2 if entity @e[team=Purple,advancements={vapmi:upgrade_currency_2=true}] run execute at @e[name="CenterP"] positioned ~ ~ ~ run function vapmi:villagers/summon-new-investments-3
execute if score _INVESTMENTS_TIER VillagerStateWhite matches 2 if entity @e[team=White,advancements={vapmi:upgrade_currency_2=true}] run execute at @e[name="CenterW"] positioned ~ ~ ~ run function vapmi:villagers/summon-new-investments-3
