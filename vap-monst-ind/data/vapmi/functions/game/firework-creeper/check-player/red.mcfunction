...
execute if score _RED_PLAYER FireworkCreeper matches 1..4 run execute at @e[name="CreeperMarker",team=Red] positioned ~2.65 ~ ~1 run tag @a[distance=0..3,dz=-4,team=Red] add Creeper_1
