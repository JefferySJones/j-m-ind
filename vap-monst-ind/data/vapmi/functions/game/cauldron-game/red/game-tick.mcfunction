...
execute if score _RED_CURRENT test matches 4 run function vapmi:game/cauldron-game/red/increase-meter
...
execute if score _RED_METER test matches 0 run execute at @e[name="CauldronR"] positioned ~-2 ~ ~1 run fill ~ ~ ~ ~ ~2 ~ gray_wool
execute if score _RED_METER test matches 1 run execute at @e[name="CauldronR"] positioned ~-2 ~ ~1 run fill ~ ~ ~ ~ ~ ~ orange_wool
execute if score _RED_METER test matches 2 run execute at @e[name="CauldronR"] positioned ~-2 ~ ~1 run fill ~ ~ ~ ~ ~1 ~ orange_wool
execute if score _RED_METER test matches 3 run execute at @e[name="CauldronR"] positioned ~-2 ~ ~1 run fill ~ ~ ~ ~ ~2 ~ orange_wool
execute if score _RED_METER test matches 4 run function vapmi:game/cauldron-game/red/reward
