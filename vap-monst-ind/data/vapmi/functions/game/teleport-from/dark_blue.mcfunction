...
# Red
execute if score _DARK_BLUE_TARGET GameState matches 1 run execute at @e[name="CenterDB"] positioned ~-21 ~ ~ run execute as @e[distance=0..2,team=Dark_Blue,type=!minecraft:player,type=!minecraft:item] at @e[type=minecraft:armor_stand,name="SpawnR",sort=random,limit=1] run tp ~ ~1 ~

# Orange
execute if score _DARK_BLUE_TARGET GameState matches 2 run execute at @e[name="CenterDB"] positioned ~-21 ~ ~ run execute as @e[distance=0..2,team=Dark_Blue,type=!minecraft:player,type=!minecraft:item] at @e[type=minecraft:armor_stand,name="SpawnO",sort=random,limit=1] run tp ~ ~1 ~

# Yellow
execute if score _DARK_BLUE_TARGET GameState matches 3 run execute at @e[name="CenterDB"] positioned ~-21 ~ ~ run execute as @e[distance=0..2,team=Dark_Blue,type=!minecraft:player,type=!minecraft:item] at @e[type=minecraft:armor_stand,name="SpawnY",sort=random,limit=1] run tp ~ ~1 ~

# Green
execute if score _DARK_BLUE_TARGET GameState matches 4 run execute at @e[name="CenterDB"] positioned ~-21 ~ ~ run execute as @e[distance=0..2,team=Dark_Blue,type=!minecraft:player,type=!minecraft:item] at @e[type=minecraft:armor_stand,name="SpawnG",sort=random,limit=1] run tp ~ ~1 ~

# Blue
execute if score _DARK_BLUE_TARGET GameState matches 5 run execute at @e[name="CenterDB"] positioned ~-21 ~ ~ run execute as @e[distance=0..2,team=Dark_Blue,type=!minecraft:player,type=!minecraft:item] at @e[type=minecraft:armor_stand,name="SpawnB",sort=random,limit=1] run tp ~ ~1 ~

# Dark_Blue
# execute if score _DARK_BLUE_TARGET GameState matches 6 run execute at @e[name="CenterDB"] positioned ~-21 ~ ~ run execute as @e[distance=0..2,team=Dark_Blue,type=!minecraft:player,type=!minecraft:item] at @e[type=minecraft:armor_stand,name="SpawnDB",sort=random,limit=1] run tp ~ ~1 ~

# Purple
execute if score _DARK_BLUE_TARGET GameState matches 7 run execute at @e[name="CenterDB"] positioned ~-21 ~ ~ run execute as @e[distance=0..2,team=Dark_Blue,type=!minecraft:player,type=!minecraft:item] at @e[type=minecraft:armor_stand,name="SpawnP",sort=random,limit=1] run tp ~ ~1 ~

# White
execute if score _DARK_BLUE_TARGET GameState matches 8 run execute at @e[name="CenterDB"] positioned ~-21 ~ ~ run execute as @e[distance=0..2,team=Dark_Blue,type=!minecraft:player,type=!minecraft:item] at @e[type=minecraft:armor_stand,name="SpawnW",sort=random,limit=1] run tp ~ ~1 ~
