...
execute if score _ARMOR_TIER VillagerStateRed matches 1 if entity @e[team=Red,advancements={vapmi:upgrade_armor_1=true}] as @e[name="CenterR"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _ARMOR_TIER VillagerStateOrange matches 1 if entity @e[team=Orange,advancements={vapmi:upgrade_armor_1=true}] as @e[name="CenterO"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _ARMOR_TIER VillagerStateYellow matches 1 if entity @e[team=Yellow,advancements={vapmi:upgrade_armor_1=true}] as @e[name="CenterY"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _ARMOR_TIER VillagerStateGreen matches 1 if entity @e[team=Green,advancements={vapmi:upgrade_armor_1=true}] as @e[name="CenterG"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _ARMOR_TIER VillagerStateBlue matches 1 if entity @e[team=Blue,advancements={vapmi:upgrade_armor_1=true}] as @e[name="CenterB"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _ARMOR_TIER VillagerStateDarkBlue matches 1 if entity @e[team=Dark_Blue,advancements={vapmi:upgrade_armor_1=true}] as @e[name="CenterDB"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _ARMOR_TIER VillagerStatePurple matches 1 if entity @e[team=Purple,advancements={vapmi:upgrade_armor_1=true}] as @e[name="CenterP"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _ARMOR_TIER VillagerStateWhite matches 1 if entity @e[team=White,advancements={vapmi:upgrade_armor_1=true}] as @e[name="CenterW"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop

# Teleport them facing the right way
# execute if score _ARMOR_TIER VillagerStateRed matches 1 if entity @e[team=Red,advancements={vapmi:upgrade_armor_1=true}] run execute at @e[name="ShopR"] run execute as @e[distance=0..10,type=minecraft:villager] run execute at @s run tp @s ~ ~ ~ facing entity @e[team=Red,limit=1,type=armor_stand,name="CenterR"]
# execute if score _ARMOR_TIER VillagerStateOrange matches 1 if entity @e[team=Orange,advancements={vapmi:upgrade_armor_1=true}] run execute at @e[name="ShopO"] run execute as @e[distance=0..10,type=minecraft:villager] run execute at @s run tp @s ~ ~ ~ facing entity @e[team=Orange,limit=1,type=armor_stand,name="CenterO"]
# execute if score _ARMOR_TIER VillagerStateYellow matches 1 if entity @e[team=Yellow,advancements={vapmi:upgrade_armor_1=true}] run execute at @e[name="ShopY"] run execute as @e[distance=0..10,type=minecraft:villager] run execute at @s run tp @s ~ ~ ~ facing entity @e[team=Yellow,limit=1,type=armor_stand,name="CenterY"]
# execute if score _ARMOR_TIER VillagerStateGreen matches 1 if entity @e[team=Green,advancements={vapmi:upgrade_armor_1=true}] run execute at @e[name="ShopG"] run execute as @e[distance=0..10,type=minecraft:villager] run execute at @s run tp @s ~ ~ ~ facing entity @e[team=Green,limit=1,type=armor_stand,name="CenterG"]
# execute if score _ARMOR_TIER VillagerStateBlue matches 1 if entity @e[team=Blue,advancements={vapmi:upgrade_armor_1=true}] run execute at @e[name="ShopB"] run execute as @e[distance=0..10,type=minecraft:villager] run execute at @s run tp @s ~ ~ ~ facing entity @e[team=Blue,limit=1,type=armor_stand,name="CenterB"]
# execute if score _ARMOR_TIER VillagerStateDarkBlue matches 1 if entity @e[team=Dark_Blue,advancements={vapmi:upgrade_armor_1=true}] run execute at @e[name="ShopDB"] run execute as @e[distance=0..10,type=minecraft:villager] run execute at @s run tp @s ~ ~ ~ facing entity @e[team=Dark_Blue,limit=1,type=armor_stand,name="CenterDB"]
# execute if score _ARMOR_TIER VillagerStatePurple matches 1 if entity @e[team=Purple,advancements={vapmi:upgrade_armor_1=true}] run execute at @e[name="ShopP"] run execute as @e[distance=0..10,type=minecraft:villager] run execute at @s run tp @s ~ ~ ~ facing entity @e[team=Purple,limit=1,type=armor_stand,name="CenterP"]
# execute if score _ARMOR_TIER VillagerStateWhite matches 1 if entity @e[team=White,advancements={vapmi:upgrade_armor_1=true}] run execute at @e[name="ShopW"] run execute as @e[distance=0..10,type=minecraft:villager] run execute at @s run tp @s ~ ~ ~ facing entity @e[team=White,limit=1,type=armor_stand,name="CenterW"]
