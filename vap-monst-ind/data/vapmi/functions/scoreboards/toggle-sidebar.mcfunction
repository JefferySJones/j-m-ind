execute if score _SIDEBAR_LOCK GameState matches 0 run execute if score _SIDEBAR GameState matches 0 run function vapmi:scoreboards/set-sidebar-mobcount
