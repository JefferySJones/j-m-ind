tellraw @p [{"text": "START: You have: "}, {"score":{"name": "_RED_OWED1", "objective": "ItemShop"}}]
tellraw @p [{"text": "(2) START: You have: "}, {"score":{"name": "_RED_OWED2", "objective": "ItemShop"}}]
...
# execute if score _RED_OWED1 ItemShop matches 20.. run tellraw @p [{"text": "(1)Taking 20 - You Owe: "}, {"score":{"name": "_RED_OWED1", "objective": "ItemShop"}}]
execute if score _RED_OWED1 ItemShop matches 20.. run scoreboard players operation _RED_OWED1 ItemShop -= 20 Constants
# execute if score _RED_OWED1 ItemShop matches 20.. run tellraw @p [{"text": "You have: "}, {"score":{"name": "_RED_OWED1", "objective": "ItemShop"}}]
...
# execute if score _RED_OWED1 ItemShop matches 10.. run tellraw @p [{"text": "(1)Taking 10 - You Owe: "}, {"score":{"name": "_RED_OWED1", "objective": "ItemShop"}}]
execute if score _RED_OWED1 ItemShop matches 10.. run scoreboard players operation _RED_OWED1 ItemShop -= 10 Constants
# execute if score _RED_OWED1 ItemShop matches 10.. run tellraw @p [{"text": "You have: "}, {"score":{"name": "_RED_OWED1", "objective": "ItemShop"}}]
...
# execute if score _RED_OWED1 ItemShop matches 5.. run tellraw @p [{"text": "(1)Taking 5 - You Owe: "}, {"score":{"name": "_RED_OWED1", "objective": "ItemShop"}}]
execute if score _RED_OWED1 ItemShop matches 5.. run scoreboard players operation _RED_OWED1 ItemShop -= 5 Constants
# execute if score _RED_OWED1 ItemShop matches 5.. run tellraw @p [{"text": "You have: "}, {"score":{"name": "_RED_OWED1", "objective": "ItemShop"}}]
...
# execute if score _RED_OWED1 ItemShop matches 2.. run tellraw @p [{"text": "(1)Taking 2 - You Owe: "}, {"score":{"name": "_RED_OWED1", "objective": "ItemShop"}}]
execute if score _RED_OWED1 ItemShop matches 2.. run scoreboard players operation _RED_OWED1 ItemShop -= 2 Constants
# execute if score _RED_OWED1 ItemShop matches 2.. run tellraw @p [{"text": "You have: "}, {"score":{"name": "_RED_OWED1", "objective": "ItemShop"}}]
...
# execute if score _RED_OWED1 ItemShop matches 1.. run tellraw @p [{"text": "(1)Taking 1 - You Owe: "}, {"score":{"name": "_RED_OWED1", "objective": "ItemShop"}}]
execute if score _RED_OWED1 ItemShop matches 1.. run scoreboard players operation _RED_OWED1 ItemShop -= 1 Constants
# execute if score _RED_OWED1 ItemShop matches 1.. run tellraw @p [{"text": "You have: "}, {"score":{"name": "_RED_OWED1", "objective": "ItemShop"}}]
...
# execute if score _RED_OWED2 ItemShop matches 20.. run tellraw @p [{"text": "(2)Taking 20 - You Owe: "}, {"score":{"name": "_RED_OWED2", "objective": "ItemShop"}}]
execute if score _RED_OWED2 ItemShop matches 20.. run scoreboard players operation _RED_OWED2 ItemShop -= 20 Constants
# execute if score _RED_OWED2 ItemShop matches 20.. run tellraw @p [{"text": "You have: "}, {"score":{"name": "_RED_OWED2", "objective": "ItemShop"}}]
...
# execute if score _RED_OWED2 ItemShop matches 10.. run tellraw @p [{"text": "(2)Taking 10 - You Owe: "}, {"score":{"name": "_RED_OWED2", "objective": "ItemShop"}}]
execute if score _RED_OWED2 ItemShop matches 10.. run scoreboard players operation _RED_OWED2 ItemShop -= 10 Constants
# execute if score _RED_OWED2 ItemShop matches 10.. run tellraw @p [{"text": "You have :"}, {"score":{"name": "_RED_OWED2", "objective": "ItemShop"}}]
...
# execute if score _RED_OWED2 ItemShop matches 5.. run tellraw @p [{"text": "(2)Taking 5 - You Owe: "}, {"score":{"name": "_RED_OWED2", "objective": "ItemShop"}}]
execute if score _RED_OWED2 ItemShop matches 5.. run scoreboard players operation _RED_OWED2 ItemShop -= 5 Constants
# execute if score _RED_OWED2 ItemShop matches 5.. run tellraw @p [{"text": "You have: "}, {"score":{"name": "_RED_OWED2", "objective": "ItemShop"}}]
...
# execute if score _RED_OWED2 ItemShop matches 2.. run tellraw @p [{"text": "(2)Taking 2 - You Owe: "}, {"score":{"name": "_RED_OWED2", "objective": "ItemShop"}}]
execute if score _RED_OWED2 ItemShop matches 2.. run scoreboard players operation _RED_OWED2 ItemShop -= 2 Constants
# execute if score _RED_OWED2 ItemShop matches 2.. run tellraw @p [{"text": "You have: "}, {"score":{"name": "_RED_OWED2", "objective": "ItemShop"}}]
...
# execute if score _RED_OWED2 ItemShop matches 1.. run tellraw @p [{"text": "(2)Taking 1 - You Owe: "}, {"score":{"name": "_RED_OWED2", "objective": "ItemShop"}}]
execute if score _RED_OWED2 ItemShop matches 1.. run scoreboard players operation _RED_OWED2 ItemShop -= 1 Constants
# execute if score _RED_OWED2 ItemShop matches 1.. run tellraw @p [{"text": "You have: "}, {"score":{"name": "_RED_OWED2", "objective": "ItemShop"}}]
