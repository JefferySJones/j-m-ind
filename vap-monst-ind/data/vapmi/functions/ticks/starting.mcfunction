...
execute if score _COUNTDOWN GameState matches 2..10 run effect give @a[team=!Debug,team=!Spectator] blindness 2 1 true
execute if score _COUNTDOWN GameState matches 2..10 run effect give @a[team=!Debug,team=!Spectator] slowness 2 255 true
execute if score _COUNTDOWN GameState matches 2..10 run effect give @a[team=!Debug,team=!Spectator] jump_boost 2 150 true
