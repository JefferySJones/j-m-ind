...
# TP to Staging Area
execute at @e[name="CenterDB"] positioned ~-21 ~ ~ run execute as @e[type=!player,type=!armor_stand,type=!villager,distance=0..4,tag=Summon_3] run execute at @s run tp @s ~ ~4 ~
