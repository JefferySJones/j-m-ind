# Clear Upgrade Food Items
clear @a[advancements={vapmi:upgrade_food_1=true}] minecraft:honey_bottle{"display":{"Name":'[{"text":"Learn To Cook With Honey","italic":false,"color":"dark_aqua"}]',"Lore":['[{"text":"Upgrade Food to Tier II","italic":true,"color":"aqua"}]']}}
clear @a[advancements={vapmi:upgrade_food_2=true}] minecraft:cake{"display":{"Name":'[{"text":"Take a Cooking Class","italic":false,"color":"dark_aqua"}]',"Lore":['[{"text":"Upgrade Food to Tier III","italic":true,"color":"aqua"}]']}}

# Clear Upgrade Potion Items
clear @a[advancements={vapmi:upgrade_potions_1=true}] minecraft:splash_potion{"display":{"Name":'[{"text":"Buy Patent for Splash Potions","italic":false,"color":"dark_aqua"}]',"Lore":['[{"text":"Upgrade Potions to Tier II","italic":true,"color":"aqua"}]']}}
...
clear @a[advancements={vapmi:upgrade_synergy_2=true}] minecraft:beacon{display:{Name:'[{"text":"Buy Ultimate Synergy Booster","italic":false,"color":"dark_aqua"}]',Lore:['[{"text":"Upgrade Synergy to Tier III","italic":true,"color":"aqua"}]']}}

# Clear Upgrade Armor Items
...
clear @a[advancements={vapmi:upgrade_currency_2=true}] minecraft:gold_block{display:{Name:'[{"text":"Invest in Gold Blocks","italic":false,"color":"gold"}]',Lore:['[{"text":"Increase coin production by +1","italic":true,"color":"aqua"}]']}}