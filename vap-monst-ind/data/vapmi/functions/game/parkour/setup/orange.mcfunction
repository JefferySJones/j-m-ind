...
execute at @e[name="Jump1O",sort=random,limit=1] positioned ~ ~2.25 ~6.75 run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:spider_eye", Count:2, tag:{display:{Name:'[{"text":"Spider Eye"}]'}}}}
