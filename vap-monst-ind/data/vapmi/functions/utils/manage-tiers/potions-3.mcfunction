...
execute if score _POTIONS_TIER VillagerStateRed matches 2 as @e[name="CenterR"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _POTIONS_TIER VillagerStateOrange matches 2 as @e[name="CenterO"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _POTIONS_TIER VillagerStateYellow matches 2 as @e[name="CenterY"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _POTIONS_TIER VillagerStateGreen matches 2 as @e[name="CenterG"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _POTIONS_TIER VillagerStateBlue matches 2 as @e[name="CenterB"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _POTIONS_TIER VillagerStateDarkBlue matches 2 as @e[name="CenterDB"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _POTIONS_TIER VillagerStatePurple matches 2 as @e[name="CenterP"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
execute if score _POTIONS_TIER VillagerStateWhite matches 2 as @e[name="CenterW"] at @s run execute as @e[name="ItemFrameShop",tag=upgradeable,limit=1,sort=nearest] run function vapmi:game/item-frame-shop/upgrade-shop
